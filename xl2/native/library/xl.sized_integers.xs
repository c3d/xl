// *****************************************************************************
// xl.sized_integers.xs                                               XL project
// *****************************************************************************
//
// File description:
//
...
// (C) 2005-2006,2008,2015,2020, Christophe de Dinechin <christophe@dinechin.org>
// *****************************************************************************
...
module XL.SIZED_INTEGERS with
    ...
    // Convert to integer
    function integer(Value : integer8) return integer                                           is XL.BYTECODE.int_from_int8
    function integer(Value : integer16) return integer                                          is XL.BYTECODE.int_from_int16
    function integer(Value : integer32) return integer                                          is XL.BYTECODE.int_from_int32
    function integer(Value : integer64) return integer                                          is XL.BYTECODE.int_from_int64
    function integer(Value : unsigned8) return integer                                          is XL.BYTECODE.int_from_uint8
    function integer(Value : unsigned16) return integer                                         is XL.BYTECODE.int_from_uint16
    function integer(Value : unsigned32) return integer                                         is XL.BYTECODE.int_from_uint32
    function integer(Value : unsigned64) return integer                                         is XL.BYTECODE.int_from_uint64

    // Convert to integer8
    function integer8(Value : integer) return integer8                                          is XL.BYTECODE.int8_from_int
    function integer8(Value : integer8) return integer8                                         is XL.BYTECODE.int8_from_int8
    function integer8(Value : integer16) return integer8                                        is XL.BYTECODE.int8_from_int16
    function integer8(Value : integer32) return integer8                                        is XL.BYTECODE.int8_from_int32
    function integer8(Value : integer64) return integer8                                        is XL.BYTECODE.int8_from_int64
    function integer8(Value : unsigned) return integer8                                         is XL.BYTECODE.int8_from_uint
    function integer8(Value : unsigned8) return integer8                                        is XL.BYTECODE.int8_from_uint8
    function integer8(Value : unsigned16) return integer8                                       is XL.BYTECODE.int8_from_uint16
    function integer8(Value : unsigned32) return integer8                                       is XL.BYTECODE.int8_from_uint32
    function integer8(Value : unsigned64) return integer8                                       is XL.BYTECODE.int8_from_uint64
    function integer8(Value : character) return integer8                                        is XL.BYTECODE.int8_from_char
    function integer8(Value : boolean) return integer8                                          is XL.BYTECODE.int8_from_bool
    function integer8(Value : real) return integer8                                             is XL.BYTECODE.int8_from_real

    // Convert to integer16
    function integer16(Value : integer) return integer16                                        is XL.BYTECODE.int16_from_int
    function integer16(Value : integer8) return integer16                                       is XL.BYTECODE.int16_from_int8
    function integer16(Value : integer16) return integer16                                      is XL.BYTECODE.int16_from_int16
    function integer16(Value : integer32) return integer16                                      is XL.BYTECODE.int16_from_int32
    function integer16(Value : integer64) return integer16                                      is XL.BYTECODE.int16_from_int64
    function integer16(Value : unsigned) return integer16                                       is XL.BYTECODE.int16_from_uint
    function integer16(Value : unsigned8) return integer16                                      is XL.BYTECODE.int16_from_uint8
    function integer16(Value : unsigned16) return integer16                                     is XL.BYTECODE.int16_from_uint16
    function integer16(Value : unsigned32) return integer16                                     is XL.BYTECODE.int16_from_uint32
    function integer16(Value : unsigned64) return integer16                                     is XL.BYTECODE.int16_from_uint64
    function integer16(Value : character) return integer16                                      is XL.BYTECODE.int16_from_char
    function integer16(Value : boolean) return integer16                                        is XL.BYTECODE.int16_from_bool
    function integer16(Value : real) return integer16                                           is XL.BYTECODE.int16_from_real

    // Convert to integer32
    function integer32(Value : integer) return integer32                                        is XL.BYTECODE.int32_from_int
    function integer32(Value : integer8) return integer32                                       is XL.BYTECODE.int32_from_int8
    function integer32(Value : integer16) return integer32                                      is XL.BYTECODE.int32_from_int16
    function integer32(Value : integer32) return integer32                                      is XL.BYTECODE.int32_from_int32
    function integer32(Value : integer64) return integer32                                      is XL.BYTECODE.int32_from_int64
    function integer32(Value : unsigned) return integer32                                       is XL.BYTECODE.int32_from_uint
    function integer32(Value : unsigned8) return integer32                                      is XL.BYTECODE.int32_from_uint8
    function integer32(Value : unsigned16) return integer32                                     is XL.BYTECODE.int32_from_uint16
    function integer32(Value : unsigned32) return integer32                                     is XL.BYTECODE.int32_from_uint32
    function integer32(Value : unsigned64) return integer32                                     is XL.BYTECODE.int32_from_uint64
    function integer32(Value : character) return integer32                                      is XL.BYTECODE.int32_from_char
    function integer32(Value : boolean) return integer32                                        is XL.BYTECODE.int32_from_bool
    function integer32(Value : real) return integer32                                           is XL.BYTECODE.int32_from_real

    // Convert to integer64
    function integer64(Value : integer) return integer64                                        is XL.BYTECODE.int64_from_int
    function integer64(Value : integer8) return integer64                                       is XL.BYTECODE.int64_from_int8
    function integer64(Value : integer16) return integer64                                      is XL.BYTECODE.int64_from_int16
    function integer64(Value : integer32) return integer64                                      is XL.BYTECODE.int64_from_int32
    function integer64(Value : integer64) return integer64                                      is XL.BYTECODE.int64_from_int64
    function integer64(Value : unsigned) return integer64                                       is XL.BYTECODE.int64_from_uint
    function integer64(Value : unsigned8) return integer64                                      is XL.BYTECODE.int64_from_uint8
    function integer64(Value : unsigned16) return integer64                                     is XL.BYTECODE.int64_from_uint16
    function integer64(Value : unsigned32) return integer64                                     is XL.BYTECODE.int64_from_uint32
    function integer64(Value : unsigned64) return integer64                                     is XL.BYTECODE.int64_from_uint64
    function integer64(Value : character) return integer64                                      is XL.BYTECODE.int64_from_char
    function integer64(Value : boolean) return integer64                                        is XL.BYTECODE.int64_from_bool
    function integer64(Value : real) return integer64                                           is XL.BYTECODE.int64_from_real

    function unsigned(Value : integer8) return unsigned                                         is XL.BYTECODE.uint_from_int8
    function unsigned(Value : integer16) return unsigned                                        is XL.BYTECODE.uint_from_int16
    function unsigned(Value : integer32) return unsigned                                        is XL.BYTECODE.uint_from_int32
    function unsigned(Value : integer64) return unsigned                                        is XL.BYTECODE.uint_from_int64
    function unsigned(Value : unsigned8) return unsigned                                        is XL.BYTECODE.uint_from_uint8
    function unsigned(Value : unsigned16) return unsigned                                       is XL.BYTECODE.uint_from_uint16
    function unsigned(Value : unsigned32) return unsigned                                       is XL.BYTECODE.uint_from_uint32
    function unsigned(Value : unsigned64) return unsigned                                       is XL.BYTECODE.uint_from_uint64
    function unsigned(Value : character) return unsigned                                        is XL.BYTECODE.uint_from_char
    function unsigned(Value : boolean) return unsigned                                          is XL.BYTECODE.uint_from_bool
    function unsigned(Value : real) return unsigned                                             is XL.BYTECODE.uint_from_real


    // Convert to unsigned8
    function unsigned8(Value : integer) return unsigned8                                        is XL.BYTECODE.uint8_from_int
    function unsigned8(Value : integer8) return unsigned8                                       is XL.BYTECODE.uint8_from_int8
    function unsigned8(Value : integer16) return unsigned8                                      is XL.BYTECODE.uint8_from_int16
    function unsigned8(Value : integer32) return unsigned8                                      is XL.BYTECODE.uint8_from_int32
    function unsigned8(Value : integer64) return unsigned8                                      is XL.BYTECODE.uint8_from_int64
    function unsigned8(Value : unsigned) return unsigned8                                       is XL.BYTECODE.uint8_from_uint
    function unsigned8(Value : unsigned8) return unsigned8                                      is XL.BYTECODE.uint8_from_uint8
    function unsigned8(Value : unsigned16) return unsigned8                                     is XL.BYTECODE.uint8_from_uint16
    function unsigned8(Value : unsigned32) return unsigned8                                     is XL.BYTECODE.uint8_from_uint32
    function unsigned8(Value : unsigned64) return unsigned8                                     is XL.BYTECODE.uint8_from_uint64
    function unsigned8(Value : character) return unsigned8                                      is XL.BYTECODE.uint8_from_char
    function unsigned8(Value : boolean) return unsigned8                                        is XL.BYTECODE.uint8_from_bool
    function unsigned8(Value : real) return unsigned8                                           is XL.BYTECODE.uint8_from_real

    // Convert to unsigned16
    function unsigned16(Value : integer) return unsigned16                                      is XL.BYTECODE.uint16_from_int
    function unsigned16(Value : integer8) return unsigned16                                     is XL.BYTECODE.uint16_from_int8
    function unsigned16(Value : integer16) return unsigned16                                    is XL.BYTECODE.uint16_from_int16
    function unsigned16(Value : integer32) return unsigned16                                    is XL.BYTECODE.uint16_from_int32
    function unsigned16(Value : integer64) return unsigned16                                    is XL.BYTECODE.uint16_from_int64
    function unsigned16(Value : unsigned) return unsigned16                                     is XL.BYTECODE.uint16_from_uint
    function unsigned16(Value : unsigned8) return unsigned16                                    is XL.BYTECODE.uint16_from_uint8
    function unsigned16(Value : unsigned16) return unsigned16                                   is XL.BYTECODE.uint16_from_uint16
    function unsigned16(Value : unsigned32) return unsigned16                                   is XL.BYTECODE.uint16_from_uint32
    function unsigned16(Value : unsigned64) return unsigned16                                   is XL.BYTECODE.uint16_from_uint64
    function unsigned16(Value : character) return unsigned16                                    is XL.BYTECODE.uint16_from_char
    function unsigned16(Value : boolean) return unsigned16                                      is XL.BYTECODE.uint16_from_bool
    function unsigned16(Value : real) return unsigned16                                         is XL.BYTECODE.uint16_from_real

    // Convert to unsigned32
    function unsigned32(Value : integer) return unsigned32                                      is XL.BYTECODE.uint32_from_int
    function unsigned32(Value : integer8) return unsigned32                                     is XL.BYTECODE.uint32_from_int8
    function unsigned32(Value : integer16) return unsigned32                                    is XL.BYTECODE.uint32_from_int16
    function unsigned32(Value : integer32) return unsigned32                                    is XL.BYTECODE.uint32_from_int32
    function unsigned32(Value : integer64) return unsigned32                                    is XL.BYTECODE.uint32_from_int64
    function unsigned32(Value : unsigned) return unsigned32                                     is XL.BYTECODE.uint32_from_uint
    function unsigned32(Value : unsigned8) return unsigned32                                    is XL.BYTECODE.uint32_from_uint8
    function unsigned32(Value : unsigned16) return unsigned32                                   is XL.BYTECODE.uint32_from_uint16
    function unsigned32(Value : unsigned32) return unsigned32                                   is XL.BYTECODE.uint32_from_uint32
    function unsigned32(Value : unsigned64) return unsigned32                                   is XL.BYTECODE.uint32_from_uint64
    function unsigned32(Value : character) return unsigned32                                    is XL.BYTECODE.uint32_from_char
    function unsigned32(Value : boolean) return unsigned32                                      is XL.BYTECODE.uint32_from_bool
    function unsigned32(Value : real) return unsigned32                                         is XL.BYTECODE.uint32_from_real

    // Convert to unsigned64
    function unsigned64(Value : integer) return unsigned64                                      is XL.BYTECODE.uint64_from_int
    function unsigned64(Value : integer8) return unsigned64                                     is XL.BYTECODE.uint64_from_int8
    function unsigned64(Value : integer16) return unsigned64                                    is XL.BYTECODE.uint64_from_int16
    function unsigned64(Value : integer32) return unsigned64                                    is XL.BYTECODE.uint64_from_int32
    function unsigned64(Value : integer64) return unsigned64                                    is XL.BYTECODE.uint64_from_int64
    function unsigned64(Value : unsigned) return unsigned64                                     is XL.BYTECODE.uint64_from_uint
    function unsigned64(Value : unsigned8) return unsigned64                                    is XL.BYTECODE.uint64_from_uint8
    function unsigned64(Value : unsigned16) return unsigned64                                   is XL.BYTECODE.uint64_from_uint16
    function unsigned64(Value : unsigned32) return unsigned64                                   is XL.BYTECODE.uint64_from_uint32
    function unsigned64(Value : unsigned64) return unsigned64                                   is XL.BYTECODE.uint64_from_uint64
    function unsigned64(Value : character) return unsigned64                                    is XL.BYTECODE.uint64_from_char
    function unsigned64(Value : boolean) return unsigned64                                      is XL.BYTECODE.uint64_from_bool
    function unsigned64(Value : real) return unsigned64                                         is XL.BYTECODE.uint64_from_real

    function real(Value : integer8) return real                                                 is XL.BYTECODE.real_from_int8
    function real(Value : integer16) return real                                                is XL.BYTECODE.real_from_int16
    function real(Value : integer32) return real                                                is XL.BYTECODE.real_from_int32
    function real(Value : integer64) return real                                                is XL.BYTECODE.real_from_int64
    function real(Value : unsigned8) return real                                                is XL.BYTECODE.real_from_uint8
    function real(Value : unsigned16) return real                                               is XL.BYTECODE.real_from_uint16
    function real(Value : unsigned32) return real                                               is XL.BYTECODE.real_from_uint32
    function real(Value : unsigned64) return real                                               is XL.BYTECODE.real_from_uint64
    ...
    function character(Value : integer8) return character                                       is XL.BYTECODE.char_from_int8
    function character(Value : integer16) return character                                      is XL.BYTECODE.char_from_int16
    function character(Value : integer32) return character                                      is XL.BYTECODE.char_from_int32
    function character(Value : integer64) return character                                      is XL.BYTECODE.char_from_int64
    function character(Value : unsigned8) return character                                      is XL.BYTECODE.char_from_uint8
    function character(Value : unsigned16) return character                                     is XL.BYTECODE.char_from_uint16
    function character(Value : unsigned32) return character                                     is XL.BYTECODE.char_from_uint32
    function character(Value : unsigned64) return character                                     is XL.BYTECODE.char_from_uint64

    function boolean(Value : integer8) return boolean                                           is XL.BYTECODE.bool_from_int8
    function boolean(Value : integer16) return boolean                                          is XL.BYTECODE.bool_from_int16
    function boolean(Value : integer32) return boolean                                          is XL.BYTECODE.bool_from_int32
    function boolean(Value : integer64) return boolean                                          is XL.BYTECODE.bool_from_int64
    function boolean(Value : unsigned8) return boolean                                          is XL.BYTECODE.bool_from_uint8
    function boolean(Value : unsigned16) return boolean                                         is XL.BYTECODE.bool_from_uint16
    function boolean(Value : unsigned32) return boolean                                         is XL.BYTECODE.bool_from_uint32
    function boolean(Value : unsigned64) return boolean                                         is XL.BYTECODE.bool_from_uint64
