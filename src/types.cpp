...
// File description:
//
//     Representation of symbolic type information
//
//     This is the part of the XL type analysis that only deals with the
//     symbolic types and is compiler-independent
//
//
//
//
...
Types::Types(Scope *scope, Tree *source)
// ----------------------------------------------------------------------------
      ...
      codegen(false)
{
    ...
    record(types,
           "Created Types %p for %t in scope %t",
           this, source, scope);
}


Types::Types(Scope *scope, Tree *source, Types *parent)
// ----------------------------------------------------------------------------
      ...
      codegen(false)
{
    ...
    record(types, "Created child Types %p from %p for %t in scope %t",
...
// ============================================================================
//
//   Virtual functions that are overriden by CompilerTypes
//
// ============================================================================

RewriteCalls *Types::NewRewriteCalls()
// ----------------------------------------------------------------------------
//   Create rewrite calls for non-compiled types
// ----------------------------------------------------------------------------
{
...
RewriteCandidate *Types::NewRewriteCandidate(Rewrite *candidate, Scope *scope)
// ----------------------------------------------------------------------------
//   Create a rewrite candidate for non-compiled types
// ----------------------------------------------------------------------------
{
    return new RewriteCandidate(candidate, scope, this);
}


Types *Types::DerivedTypesInScope(Scope *scope, Tree *source)
// ----------------------------------------------------------------------------
//    Create types derived from this within given parameter scope
// ----------------------------------------------------------------------------
{
    return new Types(scope, source, this);
}


RewriteCalls *Types::RewriteCallsFor(Tree *what)
// ----------------------------------------------------------------------------
