...
//   File Description:
// 
//     Interface for the ELIOT scanner
// 
// 
// 
// 
...
// ****************************************************************************
/*
  ELIOT scanning is quite simple. There are only five types of tokens:
  ...
  In ELIOT, indentation is significant, and represented internally by two
  ...
  and skips until an 'end of comment' token is found. For ELIOT, this is
