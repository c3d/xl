...
As you might guess, it is also possible to use the attribute syntax
for the value of `bits.width` and `bits.height`, as long as this is
how this was implemented in the `bitmap` type:
