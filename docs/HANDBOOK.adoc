...
`procedure`, `to`, `operation`, `data`, `constant`, `variable`,
`macro`, `generic`, `polymorphic`, `fast`, `small`, `global`, `thread`
and `static`. Proper use of these names also makes textual search of
the declarations or definitions easier.
