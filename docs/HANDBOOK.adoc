...
in Tao3D, with the hope that much better code quality can be achieved thanks to
a well-defined type system. This part has not been fully demonstrated yet,
although some early results using type inference techniques showed real promise.
