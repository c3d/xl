...
* `number` represent all kinds of numbers

* `natural` represent natural numbers

* `integer` represent integer numbers
...
* `range of T` is a type that represents a range of numbers, and
  features range arithmetic when applied to numbers with rounding like
