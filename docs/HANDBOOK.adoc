...
[NOTE]
=====
It is considered bad taste in XL to use `get` or `set` in the name of
attributes. For example, the following code is generally seen as being
a full 16 characters too long:
....
