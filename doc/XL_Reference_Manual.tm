...
<\body>
  ...
  <doc-data|<doc-title|The XL Programming
  ...
  XL stands for <em|Extensible Language For Everyday>. The name states the
  language's objectives:

  <\itemize>
    <item>It is <with|font-shape|italic|extensible>. One of the defining
    characteristics of XL is that you add new language constructs as easily
    ...
    the XL core library using a definition similar to what is shown in
    ...
    <item>XL is intended for <with|font-shape|italic|everyday programming>,
    making simple, everyday things easy to write, express and comprehend. For
    example, in XL, using the definition from
    ...
    </big-figure|<label|first-simple-test>A simple test in XL>
  </itemize>

  To achieve the highest degree of extensibility, XL builds on
  ...
  </footnote>. In XL, on the other hand, it is so central that it's just
  the way programs run. An XL program execution can be understood as the
  ...
  This leads to the second objective, everyday programming. XL addresses
  ...
  Thanks to meta-programming, XL can offer solutions to these problems that
  are elegant, efficient and easy to understand.

  In short, XL is an extraordinarily simple language, which at first sight
  ...
  In order to keep programs easy to write and read, the XL syntax and
  ...
  nothing left to take away. And in XL, there isn't much left to be
  removed. It's often hard to find a single character you could erase from an
  XL program, but that terseness does not come at the price of obfuscation.

  Indeed, the XL syntax will seem very natural to most programmers, except
  for what it's missing: XL makes little use of parentheses and other
  punctuation characters so typical of programming that they became a staple
  of computer screens in movies. For example, the syntax of blocks in XL is
  ...
  in XL, there are no semi-colons, dollar or at sign, and few parentheses.
  XL programs look a little like pseudo-code, except of course that they
  can be compiled and run.

  This simplicity translates into the internal representations of programs,
  which makes meta-programming not just possible, but easy and fun. Any XL
  ...
  tree)>, is a key data structure in XL, and you will soon discover just
  how powerful this simple concept is.

  The data structure chosen in XL to represent programs is simple enough to
  make meta-programming practical and easy. Meta-programming is the ability
  for a program to manipulate programs. In XL, meta-programming is so
  ...
  most fundamental operator in XL. In a sense, you can say that XL is a
  language with a single operator, <verbatim|-\<gtr\>>. This is one good
  reason why it is so hard to remove much from XL: a language with no
  ...
  extensibility. With XL, you can add language features yourself, instead
  ...
  As an element of proof that the approach works, XL actually uses rewrites
  ...
  XL standard library using regular rewrite rules. They are not built-in
  ...
  XL, creating your own <em|domain-specific
  ...
  declare a local rewrite rule in XL to perform a transformation that
  applies only in a given piece of code.

  <subsection|Using Moore's law instead of fighting it>

  The design of XL is in response to the following observation: programmers
  ...
  XL replicates the self-improvement capability of Lisp, but makes it
  central. Furthermore, it also adds a focus on user-friendly notations. In
  XL, the notation comes first, and the language is supposed to help you
  ...
  In summary, XL helps programmers take advantage of Moore's law by adding
  ...
  The key characteristics of XL outlined above are best illustrated with a
  ...
  this long-established tradition. A program writing Hello World in XL is
  ...
  this one, XL is just as terse as a typical scripting language.
  ...
  arguments. In XL, <em|map>, <em|reduce> and <em|filter> operations can
  ...
  Figure<nbsp><reference|if-then> illustrates the XL <strong|>definition of
  ...
  Figure<nbsp><reference|factorial>. This shows how, in XL,
  ...
  behind XL. The core idea is very simple:
  ...
  <paragraph|Influence on XL>XL is the first programming language
  ...
  software, at URL <hlink|http://c3d.github.io/xl|http://xlr.sourceforge.net>.
  ...
  <\itemize>
    ...
    low-level machine types most suitable to represent the XL program.
  </itemize>

  Historically, XL derives from an earlier project called XL. Experiments
  with XL have shown that it was possible to achieve performance within 15%
  of optimized C code in some cases. The current XL implementation is still
  ...
  XL source text is encoded using UTF-8. Source code is parsed into a an
  abstract syntax tree<index|abstract syntax tree> format known simply as
  <verbatim|tree><index|XL0 (abstract syntax tree for XL)> in the XL type
  system.
  ...
  XL><index|normal XL> for defaults settings such as the default syntax
  configuration, as shipped with the standard XL distribution.
  ...
  Spaces and tabs are significant at the beginning of lines. XL will use
  ...
  Comments in normal XL are similar to C++: they begin with <verbatim|/*>
  ...
  While comments play no actual role in the execution of a normal XL
  ...
  i.e. values which cannot be decomposed into smaller units from an XL
  ...
  accepted, i.e. <verbatim|16#àç> is invalid.
  ...
  <verbatim|j1> are valid XL names, whereas <verbatim|A-1>, <verbatim|1cm>
  ...
  expressions are defined in the <verbatim|xl.syntax> file.
  ...
  <verbatim|xl.syntax><index|xl.syntax> file or configured using a
  ...
  delimiters<index|block delimiters>. Normal XL recognizes the following
  ...
  <index|parsing>The XL parser only needs a small number of rules to parse
  any XL source code as a <verbatim|tree>:
  ...
  Conversely, the semi-colon in XL is right-associative, meaning that
  ...
  precedence, as this would lead to ambiguity. To enforce that rule, XL
  ...
  <index|infix vs. prefix vs. postfix>During parsing<index|parsing>, XL
  ...
  XL resolves this ambiguity as follows<\footnote>
  ...
  XL resolves the ambiguity by implementing a similar distinction. The
  ...
  normal XL ensures that most text parses as one would expect from daily
  use of English or mathematical notations.

  <subsection|Syntax configuration><label|precedence>

  <index|syntax configuration>The default XL syntax configuration file,
  ...
  configuration file. Lexical elements are identical to those of XL, as
  ...
  <\itemize>
    ...
    files<index|external syntax file>. In normal XL, a file
  ...
  <index|semantics>The semantics of XL is based entirely on the rewrite of
  abstract syntax trees represented by the <verbatim|tree> type. Tree rewrite
  operations define the execution<index|execution (of programs)> of XL
  ...
  special meaning in XL and treated specially by the XL compiler:
  ...
  <\itemize>
    ...
    performed<index|evaluation order>. XL has two infix sequence operators,
  ...
  normal XL, <verbatim|complex(3+4, 5+6)> will evaluate as
  ...
  a better way to describe data types in XL, which is detailed in
  ...
  the form <verbatim|X-\<gtr\><em|context>.A>, where <verbatim|<em|context>>
  is a data structure describing the execution context at the time
  <verbatim|A+=3> is evaluated. If there is only the declaration of
  <verbatim|A> above, <verbatim|<em|context>> might be something like
  <verbatim|(A<nbsp>as<nbsp>integer<nbsp>-\<gtr\><nbsp>5)>, i.e. a single
  binding for <verbatim|A> with type <verbatim|integer> and value
  <verbatim|5>.

  The expression <verbatim|<em|context>.A> means that we evaluate
  <verbatim|A> in that context. Therefore, assigning to <verbatim|X> will
  affect to the expression <verbatim|<em|context>.A>, and such an assignment
  modifies <verbatim|<em|context>>, i.e. it modifies the value of the
  original <verbatim|A>. If there is only the declaration of <verbatim|A>,
  then this results in an updated context that looks like <verbatim|(A as
  integer -\<gtr\> 8)>.

  <paragraph|Assignments as expressions>The value of a an assignment is the
  value bound to the reference being assigned to. Using an assignment in an
  expression<subindex|assignment|in expression><subindex|expression|assignment
  as expression> is therefore equivalent to using the value bound to the
  variable after the assignment. For instance, <verbatim|sin(x:=f(0))> is
  equivalent to <verbatim|x:=f(0)> followed by <verbatim|sin(x)>.

  <paragraph|Rationale for using <verbatim|:=> and not <verbatim|=> for
  assignment>Many programming language such as Basic or C use the equal sign
  for assignment. It is short and programmers have been used to it. So it is
  a frequent remark about XL that it should stick to this convention.

  Some languages such as Basic also use = for equality, meaning that in
  Basic, <verbatim|A=B=C> means that you assign to <verbatim|A> the value of
  a test <verbatim|B=C>, which I find a bit confusing. It also means that you
  cannot put an assignment in an expression.

  Other languages, starting with C, use a different operator for equality,
  typically <verbatim|==>. This is an endless source of errors, to the point
  where some C coding styles recommend writing <verbatim|if(3==x)> to catch
  the potential error if you had written <verbatim|if(3=x)> by mistake.

  From a conceptual point of view, equality in the mathematical sense is
  symmetrical, even in definitions. So if you write <math|a=b+1> in
  mathematics, which may have inspired the C notation, you can also write
  <math|b+1=a>, which C would not know what to do with. Unlike mathematical
  equality, assignment is assymetrical, something which is expressed by an
  operator such as <verbatim|:=>, which was chosen following languages such
  as Pascal or Ada. Compound assignment operators such as <verbatim|+=> do
  not suffer from the same problems, and can be borrowed straight from C.
  ...
  order><subindex|evaluation|order>. There is no guarantee on the order of
  evaluation inside a sequence.
  ...
  notation is called <em|array-style indexing>, as it is intended to follow
  the convention on many programming languages for
  array<subindex|array|index> indexing<index|array
  index><subindex|index|array> operations, whereas the <verbatim|A.B>
  notation is called <em|field-style indexing>, \ being intended to represent
  field indexing operations<index|field index><subindex|index|field>. Like in
  JavaScript, however, array-style and field-style indexing are very similar
  with respect to how they access data.
  ...
  The notation <verbatim|A.B> is really more general than mere indexing. It
  means ``<em|evaluate <verbatim|B> in the context defined by
  <verbatim|A>>''. For example, <verbatim|(X-\<gtr\>3).(X-2)> evaluates
  <verbatim|X-2> in a context where <verbatim|X> is bound to the value
  <verbatim|3>, so the whole expression evaluates as <verbatim|3-2>, which in
  turn evaluates to <verbatim|1>.

  <paragraph|Comparison with C>Users familiar with languages such as C may be
  somewhat disconcerted by XL's index operators. The following points are
  ...
  obey XL naming rules, e.g. to interface to a function named
  <verbatim|_foobar_>.

  Figure<nbsp><reference|C-interface> shows two ways of making the
  <verbatim|sin> function of the C standard library available to an XL
  program. The first one uses an XL-style rewrite, whereas the second one
  ...
  <big-table|<block*|<tformat|<table|<row|<cell|<strong|XL
  ...
  *>>>|<row|<cell|<verbatim|boolean>>|<cell|<verbatim|bool>>>>>>|Type
  ...
  <\warning>
    Access to the C interface syntax can be restricted for security reasons.
    In particular, it is not available to code executed remotely, nor is it
    available in pure interpreted mode. The implementation may put other
  ...
  (<hlink|http://llvm.org|http://llvm.org>). Opcodes available to XL
  ...
  <index|scope>During program execution, evaluation contexts pile up as you
  evaluate tree rewrites and bind their parameters. Therefore, a context
  during evaluation is represented not by a single set of bindings, but by a
  sequence of <verbatim|prefix> representing the hierarchy of bindings.

  A <verbatim|prefix> with two contexts, one on the left and one on the
  right, like <verbatim|{x-\<gtr\>3}{y-\<gtr\>4}>, is interpreted as meaning
  that the leftmost context, <verbatim|{x-\<gtr\>3}>, is the <em|inner
  scope>, and <verbatim|{y-\<gtr\>4}>, the rightmost context, is the
  <em|outer scope>. Therefore, the value of an expression such as
  <verbatim|({x-\<gtr\>3}{x-\<gtr\>4}).x> is <verbatim|3>, the inner scope
  being the closest one where a definition of <verbatim|x> is found. Whereas
  in an <verbatim|infix> sequence such as <verbatim|{x-\<gtr\>0;x-\<gtr\>1}>
  represents a single scope, a <verbatim|prefix> sequence represents a
  context made of multiple, nested scopes. In both cases, it is the
  <em|first> match from left to right that defines the rewrite rule being
  selected.

  When a context is a <verbatim|prefix>, the left child is called the
  <em|local scope><subindex|scope|local>. The right child of a
  <verbatim|prefix> context is the <em|enclosing
  context><subindex|context|enclosing>. All other right children in the
  sequence of left children are the local scopes of expressions currently
  being evaluated, containing the bindings for rewrite rules that were
  previously matched for evaluation purpose. The first of the left children
  being found that way is the <em|enclosing scope><subindex|scope|enclosing>
  (i.e. the local scope of the enclosing context) and the last one is the
  <em|global scope><subindex|scope|global> (i.e. the scope of global
  declarations).

  Scoping ensures that local declarations hide declarations from the
  surrounding context, since they are on the right of the left child, while
  allowing local declarations in the right child of the context to be kept in
  program order, so that the later ones are shadowed by the earlier ones.
  ...
  <index|current context><subindex|context|current>Any evaluation in XL is
  performed in a context called the <em|current context>. The current context
  is updated by the following operations:

  <\enumerate>
    <item>Evaluating the implementation of a rewrite creates a new
  ...
  assignment to identify a particular binding is called a
  <em|reference<index|reference>>. A reference can be one of the following:

  <\itemize>
    <item>An infix notation <verbatim|A.B> refers to <verbatim|B> evaluated
    in the context <verbatim|A>. It evaluates <verbatim|A>, but not
    <verbatim|B>. For example, <verbatim|A.X> refers to the name <verbatim|X>
    in the context <verbatim|A>, irrespective of the value of <verbatim|X> in
    the current context.

    <item>A prefix notation <verbatim|A[B]>, or equivalently <verbatim|A{B}>,
    <verbatim|A(B)> or even <verbatim|A B> refers to <verbatim|B> in the
    context of <verbatim|A>. It evauates <verbatim|A> and then <verbatim|B>.
    For example, <verbatim|A[X]> where <verbatim|X> is <verbatim|3> in the
    current context refers to the binding for <verbatim|3> in the context
    <verbatim|A>.

    <item>The <verbatim|left X> and <verbatim|right X> special forms refer to
    the left and right childr of <verbatim|infix>, <verbatim|prefix> or
    <verbatim|postfix> respectively. The <verbatim|child X> special form
    refers to the child of a <verbatim|block>. The special form
    <verbatim|symbol X> refers to text value corresponding to the symbol of
    an <verbatim|infix>, or to the text value of a <verbatim|name>. The
    <verbatim|opening X> and <verbatim|closing X> special forms refer to the
    text value corresponding to the opening or closing symbol of a
    <verbatim|block>. When assigned to, these references will directly modify
    the program structure for <verbatim|X>.
  </itemize>
  ...
  later, the evaluation of XL trees is performed as follows:
  ...
  declaration><subindex|type|declaration>. In XL, a type identifies the
  ...
  <index|library>The XL language is intentionally very simple, with a
  ...
  implemented in the library in XL. Implementing basic amenities that way
  ...
  <\warning>
    ...
    implementation of XL found in the open-source implementation. Since
    there is no real difference between built-in functions and library
    definitions, the XL language can be ``embedded'' in an application that
  ...
  This section decsribes the minimum list of operations available in any XL
  ...
  <verbatim|builtins.xl><index|builtins.xl> that is loaded by XL before
  ...
  Conversions to text always use the format used for XL source code, using
  ...
  XL lists use comma-separated lists<subindex|list|comma-separated>, such
  ...
  Control structures such as tests and loops are implemented in the XL
  standard library.
  ...
  The XL standard library provides a number of loop constructs.
  ...
  XL modules make it possible to decompose a large XL program in smaller
  units.
  ...
  <\itemize>
    <item>A file name provides a system-dependent file name for an XL
    source file. By convention, XL source file names end in <verbatim|.xl>.
  ...
  *Y)>|Signature for rewrite code with two variables.><label|closure-code>
  ...
  <\table-of-contents|toc>
    ...
    <with|par-left|6fn|Influence on XL <datoms|<macro|x|<repeat|<arg|x>|<with|font-series|medium|<with|font-size|1|<space|0.2fn>.<space|0.2fn>>>>>|<htab|5mm>>
  ...
  <\the-index|idx>
    ...
    <index-1|normal XL|<pageref|auto-51>>
    ...
    <index-1|XL0 (abstract syntax tree for XL)|<pageref|auto-48>>

    <index-1|XL (eXtensible Language and Runtime|<pageref|auto-5>>
...
<\references>
  <\collection>
    ...
    <associate|C-interface|<tuple|39|20|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|C-library|<tuple|4.4|27>>
    <associate|C-syntax-file|<tuple|17|14|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|C-types-conversion|<tuple|1|20|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|arbitrary-type|<tuple|56|28|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|arithmetic|<tuple|2|30|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|array-assign|<tuple|22|?>>
    <associate|assign-to-new-local|<tuple|6.15|48|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|assign-to-parameter|<tuple|35|18|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|assign-to-reference|<tuple|6.15|?>>
    <associate|assign-to-reference-example|<tuple|34|18|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|assignment|<tuple|3.1.4|17|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|assignments-cant-override-patterns|<tuple|24|14>>
    <associate|auto-1|<tuple|1|1|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|auto-10|<tuple|1.1|2|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|auto-100|<tuple|2.3.4|9|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|auto-101|<tuple|6|9|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|auto-102|<tuple|14|9|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|auto-103|<tuple|2.4|9|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|auto-104|<tuple|2.4|9|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|auto-105|<tuple|1|9|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|auto-106|<tuple|2|9|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|auto-107|<tuple|3|9|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|auto-108|<tuple|4|9|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|auto-109|<tuple|4|9|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|auto-11|<tuple|1.1|2|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|auto-110|<tuple|2.4.1|9|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|auto-111|<tuple|2.4.1|9|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|auto-112|<tuple|2.4.2|9|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|auto-113|<tuple|2.4.2|9|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|auto-114|<tuple|2.4.2|9|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|auto-115|<tuple|2.4.2|9|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|auto-116|<tuple|2.4.2|10|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|auto-117|<tuple|2.4.2|10|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|auto-118|<tuple|2.4.2|10|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|auto-119|<tuple|2.4.3|10|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|auto-12|<tuple|1.1|2|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|auto-120|<tuple|2.4.3|10|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|auto-121|<tuple|2.4.3|10|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|auto-122|<tuple|2.5|10|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|auto-123|<tuple|2.5|10|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|auto-124|<tuple|1|10|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|auto-125|<tuple|2|10|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|auto-126|<tuple|3|10|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|auto-127|<tuple|4|10|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|auto-128|<tuple|2.5.1|10|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|auto-129|<tuple|2.5.1|10|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|auto-13|<tuple|1.1|2|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|auto-130|<tuple|2.5.1|10|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|auto-131|<tuple|2.5.1|10|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|auto-132|<tuple|2.5.2|10|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|auto-133|<tuple|2.5.2|10|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|auto-134|<tuple|2.5.3|11|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|auto-135|<tuple|2.5.3|11|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|auto-136|<tuple|2.5.3|11|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|auto-137|<tuple|2.5.3|11|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|auto-138|<tuple|<with|mode|<quote|math>|\<bullet\>>|11|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|auto
../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|color-properties|<tuple|52|27|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|comma-separated-list|<tuple|6.13|11>>
    <associate|comma-separated-list-data-declaration|<tuple|28|16|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|comments|<tuple|9|7|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|comparisons|<tuple|3|30|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|complex-normal-form|<tuple|50|26|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|complex-type|<tuple|29|16|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|concept-programming|<tuple|1.5|4|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|contains-tests|<tuple|57|28|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|conversions|<tuple|8|31|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|creating-a-new-binding|<tuple|6.15|48|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|data-inheritance|<tuple|55|28|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|data-inheritance-section|<tuple|3.4.5|28|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|data-loading-operations|<tuple|11|26>>
    <associate|enum-type-definition|<tuple|75|36|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|evaluation|<tuple|3.3|21|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|evaluation-for-comparison|<tuple|41|23|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|evaluation-for-type-comparison|<tuple|42|24|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|explicit-and-automatic-type-conversions|<tuple|3.4.7|?>>
    <associate|explicit-evaluation|<tuple|3.3.4|24|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|explicit-type-conversion|<tuple|58|28|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|explicit-vs-lazy-evaluation|<tuple|43|24|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|expression-vs-statement-section|<tuple|2.5.4|11|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|extra-code-for-properties|<tuple|54|27|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|factorial|<tuple|4|4|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|first-if-then-else|<tuple|1|1|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|first-simple-test|<tuple|2|1|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|footnote-1|<tuple|1|1|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|footnote-10|<tuple|10|17|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|footnote-11|<tuple|11|23|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|footnote-12|<tuple|12|30|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|footnote-13|<tuple|13|39|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|footnote-14|<tuple|14|?>>
    <associate|footnote-2|<tuple|2|1|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|footnote-3|<tuple|3|4|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|footnote-4|<tuple|4|7|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|footnote-5|<tuple|5|8|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|footnote-6|<tuple|6|9|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|footnote-7|<tuple|7|11|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|footnote-8|<tuple|8|16|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|footnote-9|<tuple|9|16|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|footnr-1|<tuple|1|1|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|footnr-10|<tuple|10|17|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|footnr-11|<tuple|11|23|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|footnr-12|<tuple|12|30|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|footnr-13|<tuple|13|39|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|footnr-14|<tuple|14|?>>
    <associate|footnr-2|<tuple|2|1|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|footnr-3|<tuple|3|4|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|footnr-4|<tuple|4|7|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|footnr-5|<tuple|5|8|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|footnr-6|<tuple|6|9|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|footnr-7|<tuple|7|11|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|footnr-8|<tuple|8|16|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|footnr-9|<tuple|9|16|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|for-loop-container|<tuple|69|34|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|for-loop-integer-range|<tuple|68|34|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|good-function|<tuple|64|33|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|guard|<tuple|36|18|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|hello-world|<tuple|3|3|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|if-then|<tuple|6|4|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|if-then-else|<tuple|25|15|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|if-then-else-colorized|<tuple|26|16|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|if-then-else-definition|<tuple|63|33|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|implementation-notes|<tuple|6|39|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|import-statement|<tuple|4.4.1|36|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|import-statement-example|<tuple|77|36|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|index-operators|<tuple|3.1.7|19|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|infinite-data-structures|<tuple|5.7.7|38|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|infinite-list|<tuple|80|39|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|infinite-loop|<tuple|4.2.3|34|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|infix-type|<tuple|61|29|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|iterations|<tuple|3|?>>
    <associate|lazy-evaluation|<tuple|3.3.3|23|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|list-operations|<tuple|4.1.10|32|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|list-operations-table|<tuple|11|32|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|literals|<tuple|2.3|7|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|llvm-operations|<tuple|12|39|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|local-and-nonlocal-assignment|<tuple|21|13>>
    <associate|long-text-indent|<tuple|13|8|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|machine-interface|<tuple|6.14|41|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|machine-types|<tuple|6.15|41|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|making-two-types-equivalent|<tuple|48|26|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|map-reduce-filter|<tuple|5|4|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|math-operations|<tuple|6|31|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|mathematical-functions|<tuple|5|?>>
    <associate|module-definition|<tuple|78|37|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|more-specific-complex-types|<tuple|49|26|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|narrow-band-C|<tuple|7|5|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|nonlocal-assignment|<tuple|6.15|48|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|object-oriented-programming|<tuple|5.6|38|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|odd-type|<tuple|34|16>>
    <associate|off-side-rule|<tuple|8|7|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|opcode-declaration|<tuple|40|20|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|other-for-loops|<tuple|70|34|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|out-of-order-declarations|<tuple|27|16|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|parameterized-type|<tuple|60|29|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|person-properties|<tuple|26|?>>
    <associate|precedence|<tuple|2.6|11|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|properties-declaration|<tuple|51|27|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|range-type-definitino|<tuple|48|?>>
    <associate|range-type-definition|<tuple|71|35|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|ranges-as-lists|<tuple|72|35|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|references|<tuple|3.4|?>>
    <associate|return-type-declaration|<tuple|20|?>>
    <associate|rewrite-code|<tuple|82|40|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|rewrite-type|<tuple|62|29|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|sequence|<tuple|37|19|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|setting-default-arguments|<tuple|53|27|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|simple-type|<tuple|44|25|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|simpleprog|<tuple|8|3>>
    <associate|simultaneously-type-and-data|<tuple|47|?>>
    <associate|source-syntax|<tuple|16|13|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|standard-evaluation|<tuple|3.3.1|21|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|state-of-implementation|<tuple|1.6|5|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|structured-data|<tuple|38|19|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|syntax-file|<tuple|15|12|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|tail-recursion|<tuple|6.12|41|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|text-operations|<tuple|7|31|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|time-operations|<tuple|9|32|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|tree-operations|<tuple|4.1.9|32|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|tree-operations-table|<tuple|10|32|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|tree-rewrite-operators|<tuple|3.1|14|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|type-conversion|<tuple|34|17>>
    <associate|type-conversions|<tuple|3.4.7|28|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|type-declaration|<tuple|30|17|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|type-declaration-type|<tuple|76|36|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|type-definition|<tuple|3.4.2|25|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|type-name|<tuple|34|17>>
    <associate|types|<tuple|3.4|25|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|union-type-definition|<tuple|73|35|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|until-loop|<tuple|4.2.4|34|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|using-automatic-type-conversion|<tuple|35|?>>
    <associate|using-complex|<tuple|46|26|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|using-union-types|<tuple|74|35|../../eliot/doc/XL_Reference_Manual.tm>>
    <associate|while-loop|<tuple|66|34|../../eliot/doc/XL_Reference_Manual.tm>>
...
<\auxiliary>
  <\collection>
    <\associate|figure>
      <tuple|normal|Adding the if-then-else construct to
      ELSE|<pageref|auto-2>>

      <tuple|normal|A simple test in XL|<pageref|auto-3>>

      <tuple|normal|Example of Hello World program in XL|<pageref|auto-24>>

      <tuple|normal|Declaration of the factorial function|<pageref|auto-26>>

      <tuple|normal|Map, reduce and filter|<pageref|auto-32>>

      <tuple|normal|Declaration of if-then-else|<pageref|auto-34>>

      <tuple|normal|Narrow-band <with|font-family|<quote|tt>|language|<quote|verbatim>|min>
      in C|<pageref|auto-45>>

      <tuple|normal|Off-side rule: Using indentation to mark program
      structure.|<pageref|auto-63>>

      <tuple|normal|Single-line and multi-line comments|<pageref|auto-66>>

      <tuple|normal|Valid integer constants|<pageref|auto-74>>

      <tuple|normal|Valid real constants|<pageref|auto-80>>

      <tuple|normal|Valid text constants|<pageref|auto-91>>

      <tuple|normal|Long text and indentation|<pageref|auto-93>>

      <tuple|normal|Examples of valid operator and name
      symbols|<pageref|auto-102>>

      <tuple|normal|Default syntax configuration file|<pageref|auto-154>>

      <tuple|normal|Use of the <with|font-family|<quote|tt>|language|<quote|verbatim>|syntax>
      specification in a source file|<pageref|auto-156>>

      <tuple|normal|C syntax configuration file|<pageref|auto-169>>

      <tuple|normal|Example of rewrite declaration|<pageref|auto-180>>

      <tuple|normal|Example of data declaration|<pageref|auto-182>>

      <tuple|normal|Example of data declarations containing type
      declarations|<pageref|auto-184>>

      <tuple|normal|Example of guard to build the Syracuse
      suite|<pageref|auto-186>>

      <tuple|normal|Example of assignment|<pageref|auto-189>>

      <tuple|normal|Example of sequence|<pageref|auto-193>>

      <tuple|normal|Examples of index operators|<pageref|auto-195>>

      <tuple|normal|Examples of tree rewrites|<pageref|auto-200>>

      <tuple|normal|Constants vs. Variable symbols|<pageref|auto-204>>

      <tuple|normal|Declarations are visible to the entire sequence
      containing them|<pageref|auto-211>>

      <tuple|normal|Declaring a comma-separated list|<pageref|auto-215>>

      <tuple|normal|Declaring a <with|font-family|<quote|tt>|language|<quote|verbatim>|complex>
      data type|<pageref|auto-217>>

      <tuple|normal|Simple type declarations|<pageref|auto-223>>

      <tuple|normal|Creating a new binding|<pageref|auto-232>>

      <tuple|normal|Assignment to existing binding|<pageref|auto-233>>

      <tuple|normal|Assigning to new local variable |<pageref|auto-242>>

      <tuple|normal|Assignment to references|<pageref|auto-244>>

      <tuple|normal|Assigning to parameter|<pageref|auto-248>>

      <tuple|normal|Guard limit the validity of
      operations|<pageref|auto-255>>
      ...
      <with|font-family|<quote|tt>|language|<quote|verbatim>|f(100)+f(200)>|<pageref|auto-260>>

      <tuple|normal|Structured data|<pageref|auto-271>>

      <tuple|normal|Creating an interface for a C
      function|<pageref|auto-277>>

      <tuple|normal|Generating machine code using opcode
      declarations|<pageref|auto-285>>

      <tuple|normal|Evaluation for comparison|<pageref|auto-328>>

      <tuple|normal|Evaluation for type comparison|<pageref|auto-329>>

      <tuple|normal|Explicit vs. lazy evaluation|<pageref|auto-335>>

      <tuple|normal|Simple type declaration|<pageref|auto-363>>

      <tuple|normal|Simple type declaration|<pageref|auto-367>>

      <tuple|normal|Using the <with|font-family|<quote|tt>|language|<quote|verbatim>|complex>
      type|<pageref|auto-370>>

      <tuple|normal|Binding for a <with|font-family|<quote|tt>|language|<quote|verbatim>|complex>
      parameter|<pageref|auto-374>>

      <tuple|normal|Making type <with|font-family|<quote|tt>|language|<quote|verbatim>|A>
      equivalent to type <with|font-family|<quote|tt>|language|<quote|verbatim>|B>|<pageref|auto-375>>

      <tuple|normal|Named patterns for <with|font-family|<quote|tt>|language|<quote|verbatim>|complex>|<pageref|auto-380>>

      <tuple|normal|Creating a normal form for the complex
      type|<pageref|auto-382>>

      <tuple|normal|Properties declaration|<pageref|auto-388>>

      <tuple|normal|Color properties|<pageref|auto-397>>

      <tuple|normal|Setting default arguments from the current
      context|<pageref|auto-400>>

      <tuple|normal|Additional code in properties|<pageref|auto-403>>

      <tuple|normal|Data inheritance|<pageref|auto-407>>

      <tuple|normal|Defining a type identifying an arbitrary AST
      shape|<pageref|auto-416>>

      <tuple|normal|Explicit type check|<pageref|auto-418>>

      <tuple|normal|Explicit type conversion|<pageref|auto-422>>

      <tuple|normal|Automatic type conversion|<pageref|auto-424>>

      <tuple|normal|Parameterized type|<pageref|auto-428>>

      <tuple|normal|Declaring a range type using an infix
      form|<pageref|auto-429>>

      <tuple|normal|Declaration of a rewrite type|<pageref|auto-433>>

      <tuple|normal|Library definition of if-then-else|<pageref|auto-492>>

      <tuple|normal|The <with|font-family|<quote|tt>|language|<quote|verbatim>|good>
      function|<pageref|auto-494>>

      <tuple|normal|Infinite loop|<pageref|auto-496>>

      <tuple|normal|While loop|<pageref|auto-498>>

      <tuple|normal|Until loop|<pageref|auto-499>>

      <tuple|normal|For loop on an integer range|<pageref|auto-501>>

      <tuple|normal|For loop on a container|<pageref|auto-502>>

      <tuple|normal|Other kinds of <with|font-family|<quote|tt>|language|<quote|verbatim>|for>
      loop|<pageref|auto-503>>

      <\tuple|normal>
        Range and range type definition
      </tuple|<pageref|auto-508>>

      <tuple|normal|Ranges as lists|<pageref|auto-510>>

      <tuple|normal|Union type definition|<pageref|auto-512>>

      <tuple|normal|Using union types|<pageref|auto-513>>

      <tuple|normal|Enumeration type definition|<pageref|auto-515>>

      <tuple|normal|Type matching a type declaration|<pageref|auto-517>>

      <tuple|normal|Import statements examples|<pageref|auto-523>>

      <tuple|normal|Module definition|<pageref|auto-534>>

      <tuple|normal|Computing a minimum and a maximum|<pageref|auto-537>>

      <tuple|normal|Lazy evaluation of an infinite list|<pageref|auto-558>>

      <tuple|normal|Controlled compilation|<pageref|auto-564>>

      <tuple|normal|Signature for rewrite code with two
      variables.|<pageref|auto-573>>

      <tuple|normal|Signature for rewrite code with two
      variables.|<pageref|auto-576>>
    </associate>
    <\associate|idx>
      <tuple|<tuple|integer type>|<pageref|auto-5>>

      <tuple|<tuple|real type>|<pageref|auto-6>>

      <tuple|<tuple|text type>|<pageref|auto-7>>

      <tuple|<tuple|name type>|<pageref|auto-8>>

      <tuple|<tuple|infix type>|<pageref|auto-9>>

      <tuple|<tuple|prefix type>|<pageref|auto-10>>

      <tuple|<tuple|postfix type>|<pageref|auto-11>>

      <tuple|<tuple|block type>|<pageref|auto-12>>

      <tuple|<tuple|abstract syntax tree>|<pageref|auto-13>>

      <tuple|<tuple|AST (abstract syntax tree)>|<pageref|auto-14>>

      <tuple|<tuple|domain-specific language>|<pageref|auto-16>>

      <tuple|<tuple|DSL (domain-specific language)>|<pageref|auto-17>>

      <tuple|<tuple|programming paradigm>|<pageref|auto-19>>

      <tuple|<tuple|functional programming>|<pageref|auto-21>>

      <tuple|<tuple|meta-programming>|<pageref|auto-22>>

      <tuple|<tuple|structured node types>|<pageref|auto-104>>

      <tuple|<tuple|infix>|<pageref|auto-105>>

      <tuple|<tuple|prefix>|<pageref|auto-106>>

      <tuple|<tuple|postfix>|<pageref|auto-107>>

      <tuple|<tuple|block>|<pageref|auto-108>>

      <tuple|<tuple|child node>|<pageref|auto-109>>

      <tuple|<tuple|infix>|<pageref|auto-111>>

      <tuple|<tuple|prefix>|<pageref|auto-113>>

      <tuple|<tuple|postfix>|<pageref|auto-114>>

      <tuple|<tuple|operand (in prefix and postfix)>|<pageref|auto-115>>

      <tuple|<tuple|xl.syntax>|<pageref|auto-116>>

      <tuple|<tuple|function precedence>|<pageref|auto-117>>

      <tuple|<tuple|function>|<pageref|auto-118>>

      <tuple|<tuple|block>|<pageref|auto-120>>

      <tuple|<tuple|block delimiters>|<pageref|auto-121>>

      <tuple|<tuple|parsing>|<pageref|auto-123>>

      <tuple|<tuple|precedence>|<pageref|auto-124>>

      <tuple|<tuple|associativity>|<pageref|auto-125>>

      <tuple|<tuple|infix vs. prefix vs. postfix>|<pageref|auto-126>>

      <tuple|<tuple|expression vs. statement>|<pageref|auto-127>>

      <tuple|<tuple|precedence>|<pageref|auto-129>>

      <tuple|<tuple|xl.syntax>|<pageref|auto-130>>

      <tuple|<tuple|syntax statement>|<pageref|auto-131>>

      <tuple|<tuple|associativity>|<pageref|auto-133>>

      <tuple|<tuple|infix vs. prefix vs. postfix>|<pageref|auto-135>>

      <tuple|<tuple|parsing>|<pageref|auto-136>>

      <tuple|<tuple|parsing ambiguities>|<pageref|auto-137>>

      <tuple|<tuple|default prefix (precedence)>|<pageref|auto-138>>

      <tuple|<tuple|function precedence>|<pageref|auto-139>>

      <tuple|<tuple|syntax configuration>|<pageref|auto-140>>

      <tuple|<tuple|expression vs. statement>|<pageref|auto-142>>

      <tuple|<tuple|parsing ambiguities>|<pageref|auto-143>>

      <tuple|<tuple|statement>|<pageref|auto-144>>

      <tuple|<tuple|expression (as opposed to statement)>|<pageref|auto-145>>

      <tuple|<tuple|subject and complement>|<pageref|auto-146>>

      <tuple|<tuple|statement precedence>|<pageref|auto-147>>

      <tuple|<tuple|syntax configuration>|<pageref|auto-149>>

      <tuple|<tuple|xl.syntax>|<pageref|auto-150>>

      <tuple|<tuple|operators>|<pageref|auto-151>>

      <tuple|<tuple|standard operators>|<pageref|auto-152>>

      <tuple|<tuple|precedence>|<pageref|auto-153>>

      <tuple|<tuple|syntax statement>|<pageref|auto-155>>

      <tuple|<tuple|syntax statement>|<pageref|auto-157>>

      <tuple|<tuple|indentation>|<pageref|auto-159>>

      <tuple|<tuple|statement precedence>|<pageref|auto-160>>

      <tuple|<tuple|default precedence>|<pageref|auto-161>>

      <tuple|<tuple|function precedence>|<pageref|auto-162>>

      <tuple|<tuple|block delimiters>|<pageref|auto-163>>

      <tuple|<tuple|indentation>|<pageref|auto-164>>

      <tuple|<tuple|text delimiters>|<pageref|auto-165>>

      <tuple|<tuple|external syntax file>|<pageref|auto-166>>

      <tuple|<tuple|C.syntax file>|<pageref|auto-167>>

      <tuple|<tuple|C symbols>|<pageref|auto-168>>

      <tuple|<tuple|semantics>|<pageref|auto-171>>

      <tuple|<tuple|execution (of programs)>|<pageref|auto-172>>

      <tuple|<tuple|evaluation>|<pageref|auto-173>>

      <tuple|<tuple|tree rewrite>|<pageref|auto-175>>

      <tuple|<tuple|tree rewrite operators>|<pageref|auto-176>>

      <tuple|<tuple|rewrite declarations>|<pageref|auto-177>>

      <tuple|<tuple|pattern>|<pageref|auto-178>>

      <tuple|<tuple|implementation>|<pageref|auto-179>>

      <tuple|<tuple|data declarations>|<pageref|auto-181>>

      <tuple|<tuple|type declarations>|<pageref|auto-183>>

      <tuple|<tuple|guard (in a rewrite declaration)>|<pageref|auto-185>>

      <tuple|<tuple|assignment>|<pageref|auto-187>>

      <tuple|<tuple|binding>|<pageref|auto-188>>

      <tuple|<tuple|sequence>|<pageref|auto-190>>

      <tuple|<tuple|sequence operator>|<pageref|auto-191>>

      <tuple|<tuple|evaluation order>|<pageref|auto-192>>

      <tuple|<tuple|index operator>|<pageref|auto-194>>

      <tuple|<tuple|declaration|of rewrites>|<pageref|auto-197>>

      <tuple|<tuple|rewrite declaration>|<pageref|auto-198>>

      <tuple|<tuple|if-then-else|statement>|<pageref|auto-199>>

      <tuple|<tuple|pattern>|<pageref|auto-201>>

      <tuple|<tuple|constant>|<pageref|auto-202>>

      <tuple|<tuple|variable>|<pageref|auto-203>>

      <tuple|<tuple|constant symbols>|<pageref|auto-205>>

      <tuple|<tuple|parameter>|<pageref|auto-206>>

      <tuple|<tuple|argument>|<pageref|auto-207>>

      <tuple|<tuple|anonymous function>|<pageref|auto-208>>

      <tuple|<tuple|lambda function>|<pageref|auto-209>>

      <tuple|<tuple|context>|<pageref|auto-210>>

      <tuple|<tuple|declaration|of data>|<pageref|auto-213>>

      <tuple|<tuple|data declaration>|<pageref|auto-214>>

      <tuple|<tuple|evaluation|data declaration
      arguments>|<pageref|auto-216>>

      <tuple|<tuple|self>|<pageref|auto-218>>

      <tuple|<tuple|declaration|of types>|<pageref|auto-220>>

      <tuple|<tuple|type declaration>|<pageref|auto-221>>

      <tuple|<tuple|return type declaration>|<pageref|auto-222>>

      <tuple|<tuple|overloading>|<pageref|auto-224>>

      <tuple|<tuple|type declaration|in assignment>|<pageref|auto-225>>

      <tuple|<tuple|assignment|to type declaration>|<pageref|auto-226>>

      <tuple|<tuple|assignment>|<pageref|auto-228>>

      <tuple|<tuple|:=>|<pageref|auto-229>>

      <tuple|<tuple|evaluation|in assignment>|<pageref|auto-230>>

      <tuple|<tuple|binding|in assignment>|<pageref|auto-231>>

      <tuple|<tuple|assignment|to type declaration>|<pageref|auto-235>>

      <tuple|<tuple|type declaration|in assignment>|<pageref|auto-236>>

      <tuple|<tuple|binding|local scope>|<pageref|auto-237>>

      <tuple|<tuple|local scope>|<pageref|auto-238>>

      <tuple|<tuple|scope|local>|<pageref|auto-239>>

      <tuple|<tuple|return type declaration|in
      assignment>|<pageref|auto-240>>

      <tuple|<tuple|binding|with return type declaration>|<pageref|auto-241>>

      <tuple|<tuple|expression|allowed on left of
      assignment>|<pageref|auto-245>>

      <tuple|<tuple|assignment|to parameter>|<pageref|auto-247>>

      <tuple|<tuple|assignment|in expression>|<pageref|auto-250>>

      <tuple|<tuple|expression|assignment as expression>|<pageref|auto-251>>

      <tuple|<tuple|guard>|<pageref|auto-253>>

      <tuple|<tuple|when infix operator>|<pageref|auto-254>>

      <tuple|<tuple|sequence>|<pageref|auto-257>>

      <tuple|<tuple|sequence|evaluation order>|<pageref|auto-258>>

      <tuple|<tuple|evaluation|order>|<pageref|auto-259>>

      <tuple|<tuple|declaration>|<pageref|auto-261>>

      <tuple|<tuple|statement>|<pageref|auto-262>>

      <tuple|<tuple|index operator>|<pageref|auto-264>>

      <tuple|<tuple|dot|as index operator>|<pageref|auto-265>>

      <tuple|<tuple|array|index>|<pageref|auto-266>>

      <tuple|<tuple|array index>|<pageref|auto-267>>

      <tuple|<tuple|index|array>|<pageref|auto-268>>

      <tuple|<tuple|field index>|<pageref|auto-269>>

      <tuple|<tuple|index|field>|<pageref|auto-270>>

      <tuple|<tuple|array|as function>|<pageref|auto-273>>

      <tuple|<tuple|C interface>|<pageref|auto-275>>

      <tuple|<tuple|extern syntax>|<pageref|auto-276>>

      <tuple|<tuple|C.syntax>|<pageref|auto-278>>

      <tuple|<tuple|xl.syntax|connexion to C.syntax>|<pageref|auto-279>>

      <tuple|<tuple|C.syntax|connexion to xl.syntax>|<pageref|auto-280>>

      <tuple|<tuple|machine interface>|<pageref|auto-283>>

      <tuple|<tuple|opcode>|<pageref|auto-284>>

      <tuple|<tuple|binding>|<pageref|auto-287>>

      <tuple|<tuple|context>|<pageref|auto-288>>

      <tuple|<tuple|context order>|<pageref|auto-290>>

      <tuple|<tuple|shadowed binding>|<pageref|auto-291>>

      <tuple|<tuple|scope>|<pageref|auto-293>>

      <tuple|<tuple|scope|local>|<pageref|auto-294>>

      <tuple|<tuple|context|enclosing>|<pageref|auto-295>>

      <tuple|<tuple|scope|enclosing>|<pageref|auto-296>>

      <tuple|<tuple|scope|global>|<pageref|auto-297>>

      <tuple|<tuple|catch-all rewrite>|<pageref|auto-298>>

      <tuple|<tuple|undefined form>|<pageref|auto-299>>

      <tuple|<tuple|current context>|<pageref|auto-301>>

      <tuple|<tuple|context|current>|<pageref|auto-302>>

      <tuple|<tuple|scope|creation>|<pageref|auto-303>>

      <tuple|<tuple|assignment>|<pageref|auto-304>>

      <tuple|<tuple|reference>|<pageref|auto-306>>

      <tuple|<tuple|index operator>|<pageref|auto-307>>

      <tuple|<tuple|evaluation>|<pageref|auto-309>>

      <tuple|<tuple|evaluation|standard case>|<pageref|auto-311>>

      <tuple|<tuple|context order>|<pageref|auto-312>>

      <tuple|<tuple|pattern|matching>|<pageref|auto-313>>

      <tuple|<tuple|evaluation|of arguments>|<pageref|auto-314>>

      <tuple|<tuple|memoization|of arguments>|<pageref|auto-315>>

      <tuple|<tuple|evaluation|mismatch>|<pageref|auto-316>>

      <tuple|<tuple|binding|parameters>|<pageref|auto-317>>

      <tuple|<tuple|context|passed with arguments>|<pageref|auto-318>>

      <tuple|<tuple|closure>|<pageref|auto-319>>

      <tuple|<tuple|context|parameter context>|<pageref|auto-320>>

      <tuple|<tuple|special forms>|<pageref|auto-322>>

      <tuple|<tuple|evaluation|special forms>|<pageref|auto-323>>

      <tuple|<tuple|lazy evaluation>|<pageref|auto-325>>

      <tuple|<tuple|evaluation|lazy>|<pageref|auto-326>>

      <tuple|<tuple|evaluation|demand-based>|<pageref|auto-327>>

      <tuple|<tuple|explicit evaluation>|<pageref|auto-331>>

      <tuple|<tuple|evaluation|explicit>|<pageref|auto-332>>

      <tuple|<tuple|memoization|of parameters>|<pageref|auto-334>>

      <tuple|<tuple|evaluation|explicit vs. lazy>|<pageref|auto-336>>

      <tuple|<tuple|evaluation|forcing explicit
      evaluation>|<pageref|auto-337>>

      <tuple|<tuple|type>|<pageref|auto-339>>

      <tuple|<tuple|type declaration>|<pageref|auto-340>>

      <tuple|<tuple|type|declaration>|<pageref|auto-341>>

      <tuple|<tuple|type|belonging to a type>|<pageref|auto-342>>

      <tuple|<tuple|type|predefined>|<pageref|auto-344>>

      <tuple|<tuple|predefined types>|<pageref|auto-345>>

      <tuple|<tuple|integer>|<pageref|auto-346>>

      <tuple|<tuple|real>|<pageref|auto-347>>

      <tuple|<tuple|text>|<pageref|auto-348>>

      <tuple|<tuple|symbol>|<pageref|auto-349>>

      <tuple|<tuple|name>|<pageref|auto-350>>

      <tuple|<tuple|operator>|<pageref|auto-351>>

      <tuple|<tuple|infix>|<pageref|auto-352>>

      <tuple|<tuple|prefix>|<pageref|auto-353>>

      <tuple|<tuple|postfix>|<pageref|auto-354>>

      <tuple|<tuple|block>|<pageref|auto-355>>

      <tuple|<tuple|tree>|<pageref|auto-356>>

      <tuple|<tuple|boolean>|<pageref|auto-357>>

      <tuple|<tuple|type definition>|<pageref|auto-359>>

      <tuple|<tuple|type|definition>|<pageref|auto-360>>

      <tuple|<tuple|definition|of types>|<pageref|auto-361>>

      <tuple|<tuple|if-then-else|type>|<pageref|auto-362>>

      <tuple|<tuple|type pattern>|<pageref|auto-364>>

      <tuple|<tuple|type|pattern>|<pageref|auto-365>>

      <tuple|<tuple|pattern|in type>|<pageref|auto-366>>

      <tuple|<tuple|type declaration|vs. type definition>|<pageref|auto-368>>

      <tuple|<tuple|type definition|vs. type declaration>|<pageref|auto-369>>

      <tuple|<tuple|parameters|of types>|<pageref|auto-371>>

      <tuple|<tuple|bindings|in type definitions>|<pageref|auto-372>>

      <tuple|<tuple|index|for user-defined types>|<pageref|auto-373>>

      <tuple|<tuple|normal form>|<pageref|auto-377>>

      <tuple|<tuple|type|normal form>|<pageref|auto-378>>

      <tuple|<tuple|pattern|making type pattern specific>|<pageref|auto-379>>

      <tuple|<tuple|type|multiple notations>|<pageref|auto-381>>

      <tuple|<tuple|properties>|<pageref|auto-384>>

      <tuple|<tuple|type|properties>|<pageref|auto-385>>

      <tuple|<tuple|property>|<pageref|auto-386>>

      <tuple|<tuple|inherit>|<pageref|auto-387>>

      <tuple|<tuple|parameters|with properties types>|<pageref|auto-389>>

      <tuple|<tuple|property definition>|<pageref|auto-390>>

      <tuple|<tuple|definition|of properties>|<pageref|auto-391>>

      <tuple|<tuple|default value>|<pageref|auto-392>>

      <tuple|<tuple|property|default value>|<pageref|auto-393>>

      <tuple|<tuple|property|setting>|<pageref|auto-394>>

      <tuple|<tuple|properties|as parameter types>|<pageref|auto-395>>

      <tuple|<tuple|properties|arguments>|<pageref|auto-396>>

      <tuple|<tuple|getter>|<pageref|auto-398>>

      <tuple|<tuple|setter>|<pageref|auto-399>>

      <tuple|<tuple|required property>|<pageref|auto-401>>

      <tuple|<tuple|property|required>|<pageref|auto-402>>

      <tuple|<tuple|inherit>|<pageref|auto-405>>

      <tuple|<tuple|data inheritance>|<pageref|auto-406>>

      <tuple|<tuple|automatic type conversion>|<pageref|auto-408>>

      <tuple|<tuple|explicit type check>|<pageref|auto-410>>

      <tuple|<tuple|type|explicit type check>|<pageref|auto-411>>

      <tuple|<tuple|type check>|<pageref|auto-412>>

      <tuple|<tuple|type|check>|<pageref|auto-413>>

      <tuple|<tuple|contains>|<pageref|auto-414>>

      <tuple|<tuple|type|identifying arbitrary tree
      shapes>|<pageref|auto-415>>

      <tuple|<tuple|is_a>|<pageref|auto-417>>

      <tuple|<tuple|explicit type conversion>|<pageref|auto-420>>

      <tuple|<tuple|type|conversions>|<pageref|auto-421>>

      <tuple|<tuple|automatic type conversion>|<pageref|auto-423>>

      <tuple|<tuple|parameterized types>|<pageref|auto-426>>

      <tuple|<tuple|type|parameterized type>|<pageref|auto-427>>

      <tuple|<tuple|rewrite type>|<pageref|auto-431>>

      <tuple|<tuple|type|rewrite type>|<pageref|auto-432>>

      <tuple|<tuple|library>|<pageref|auto-435>>

      <tuple|<tuple|built-in operations>|<pageref|auto-437>>

      <tuple|<tuple|xl.syntax>|<pageref|auto-438>>

      <tuple|<tuple|builtins.xl>|<pageref|auto-439>>

      <tuple|<tuple|arithmetic>|<pageref|auto-441>>

      <tuple|<tuple|power operator>|<pageref|auto-442>>

      <tuple|<tuple|comparisons>|<pageref|auto-445>>

      <tuple|<tuple|bitwise arithmetic>|<pageref|auto-448>>

      <tuple|<tuple|arithmetic|bitwise>|<pageref|auto-449>>

      <tuple|<tuple|boolean>|<pageref|auto-452>>

      <tuple|<tuple|mathematical functions>|<pageref|auto-455>>

      <tuple|<tuple|text functions>|<pageref|auto-458>>

      <tuple|<tuple|conversions>|<pageref|auto-461>>

      <tuple|<tuple|type|conversions>|<pageref|auto-462>>

      <tuple|<tuple|conversion|from text to number>|<pageref|auto-464>>

      <tuple|<tuple|conversion|from number to text>|<pageref|auto-465>>

      <tuple|<tuple|date and time>|<pageref|auto-467>>

      <tuple|<tuple|tree|operations>|<pageref|auto-470>>

      <tuple|<tuple|AST|manipulations>|<pageref|auto-471>>

      <tuple|<tuple|left>|<pageref|auto-473>>

      <tuple|<tuple|right>|<pageref|auto-474>>

      <tuple|<tuple|child>|<pageref|auto-475>>

      <tuple|<tuple|symbol>|<pageref|auto-476>>

      <tuple|<tuple|opening>|<pageref|auto-477>>

      <tuple|<tuple|closing>|<pageref|auto-478>>

      <tuple|<tuple|list operations>|<pageref|auto-480>>

      <tuple|<tuple|list|operations on lists>|<pageref|auto-481>>

      <tuple|<tuple|list|comma-separated>|<pageref|auto-482>>

      <tuple|<tuple|map operation>|<pageref|auto-484>>

      <tuple|<tuple|reduce operation>|<pageref|auto-485>>

      <tuple|<tuple|filter operation>|<pageref|auto-486>>

      <tuple|<tuple|predicate>|<pageref|auto-487>>

      <tuple|<tuple|range>|<pageref|auto-488>>

      <tuple|<tuple|if-then-else|library definition>|<pageref|auto-491>>

      <tuple|<tuple|good (function)>|<pageref|auto-493>>

      <tuple|<tuple|interval arithmetic>|<pageref|auto-509>>

      <tuple|<tuple|module>|<pageref|auto-520>>

      <tuple|<tuple|import>|<pageref|auto-521>>

      <tuple|<tuple|module|import>|<pageref|auto-522>>

      <tuple|<tuple|module path>|<pageref|auto-524>>

      <tuple|<tuple|short module name>|<pageref|auto-525>>

      <tuple|<tuple|import|with a short name>|<pageref|auto-526>>

      <tuple|<tuple|syntax|in modules>|<pageref|auto-527>>

      <tuple|<tuple|scope|for modules>|<pageref|auto-528>>

      <tuple|<tuple|shadowing|in modules>|<pageref|auto-529>>

      <tuple|<tuple|binding|of module names>|<pageref|auto-530>>

      <tuple|<tuple|module description>|<pageref|auto-532>>

      <tuple|<tuple|module|description>|<pageref|auto-533>>

      <tuple|<tuple|symbols>|<pageref|auto-90>>
    </associate>
    <\associate|table>
      <tuple|normal|Type correspondances in a C interface|<pageref|auto-281>>

      <tuple|normal|Arithmetic operations|<pageref|auto-443>>

      <tuple|normal|Comparisons|<pageref|auto-446>>

      <tuple|normal|Bitwise arithmetic operations|<pageref|auto-450>>

      <tuple|normal|Boolean operations|<pageref|auto-453>>

      <tuple|normal|Mathematical operations|<pageref|auto-456>>

      <tuple|normal|Text operations|<pageref|auto-459>>

      <tuple|normal|Conversions|<pageref|auto-463>>

      <tuple|normal|Date and time|<pageref|auto-468>>

      <tuple|normal|Tree operations|<pageref|auto-472>>

      <tuple|normal|List operations|<pageref|auto-483>>

      <tuple|normal|LLVM operations|<pageref|auto-565>>
    </associate>
    <\associate|toc>
      ...
      <with|par-left|<quote|4tab>|Influence on XL
      <datoms|<macro|x|<repeat|<arg|x>|<with|font-series|medium|<with|font-size|1|<space|0.2fn>.<space|0.2fn>>>>>|<htab|5mm>>
      ...
      symbols<flag|index|dark green|key><assign|auto-nr|96><write|idx|<tuple|<tuple|symbols>|<pageref|auto-96>>>
      <datoms|<macro|x|<repeat|<arg|x>|<with|font-series|medium|<with|font-size|1|<space|0.2fn>.<space|0.2fn>>>>>|<htab|5mm>>
      <no-break><pageref|auto-96>>
      ...
      <datoms|<macro|x|<repeat|<arg|x>|<with|font-series|medium|<with|font-size|1|<space|0.2fn>.<space|0.2fn>>>>>|<htab|5mm>>
      <no-break><pageref|auto-243><vspace|0.15fn>>

      <with|par-left|<quote|4tab>|Assigning to parameters
      <datoms|<macro|x|<repeat|<arg|x>|<with|font-series|medium|<with|font-size|1|<space|0.2fn>.<space|0.2fn>>>>>|<htab|5mm>>
      <no-break><pageref|auto-246><vspace|0.15fn>>

      <with|par-left|<quote|4tab>|Assignments as expressions
      <datoms|<macro|x|<repeat|<arg|x>|<with|font-series|medium|<with|font-size|1|<space|0.2fn>.<space|0.2fn>>>>>|<htab|5mm>>
      <no-break><pageref|auto-249><vspace|0.15fn>>
      ...
      XL library> <datoms|<macro|x|<repeat|<arg|x>|<with|font-series|medium|<with|font-size|1|<space|0.2fn>.<space|0.2fn>>>>>|<htab|5mm>>
      <no-break><pageref|auto-434><vspace|0.5fn>
      ...
      code> <datoms|<macro|x|<repeat|<arg|x>|<with|font-series|medium|<with|font-size|1|<space|0.2fn>.<space|0.2fn>>>>>|<htab|5mm>>
      <no-break><pageref|auto-535><vspace|0.5fn>
      ...
      notes> <datoms|<macro|x|<repeat|<arg|x>|<with|font-series|medium|<with|font-size|1|<space|0.2fn>.<space|0.2fn>>>>>|<htab|5mm>>
      <no-break><pageref|auto-559><vspace|0.5fn>
