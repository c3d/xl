...
[arabic]
. XL has a method to extend the language(((extensibility,language))) with any
...
[arabic]
. Flexibility(((flexibility,library))): It is much easier to offer a
...
. Extensibility(((extensibility,library))): If the library definition is
  ...
  language.
. Fixability(((flexibility,library))): Built-in mechanisms, such as
  library versioning(((versioning,library))), make it possible to
...
link:../native/lib/xl/math/complex.xs[complex numbers module]
...
safety))) and extensible(((extensible function)))(((extensibility))),
